...
* **RNF03 - Performance e Predição:** O sistema deve ser capaz de processar os cruzamentos de dados (frequência, notas, engajamento) em segundo plano, garantindo que a emissão de alertas na interface do professor (durante a chamada) ocorra em tempo real, sem travamentos.
